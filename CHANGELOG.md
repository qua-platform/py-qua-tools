...
- digital_filters - added `dual_exponential_decay` and `triple_exponential decay` which can be used to fit and extract the exponential decay coefficients when there are multiple time constants
### Changed
