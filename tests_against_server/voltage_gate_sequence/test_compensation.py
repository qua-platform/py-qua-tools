...
seq = VoltageGateSequence(config, ["P1_sticky", "P2_sticky", "P3_sticky", "P4_sticky"])
...
with program() as prog:
    ...
    a = declare(fixed, value=0.07)
    b = declare(fixed, value=0.01)
    ...
    seq.add_compensation_pulse(duration=60000)
...
if simulate:
    ...
    plt.legend("")
    plt.subplot(212)
    get_filtered_voltage(job.get_simulated_samples().con1.analog["1"], 1e-9, 1000, True)
