...
PORT_POSITIONS = {
    "lf-fem": {
        "output": [(0.05 + 0.25/8*3, 1 - i * PORT_SPACING_FACTOR) for i in range(8)],
        "input": [(0.05 + 0.75/8*3, 1 - (6+i) * PORT_SPACING_FACTOR) for i in range(2)],
    },
    "mw-fem": {
        "output": [(0.05 + 0.25/8*3, 1 - i * PORT_SPACING_FACTOR) for i in range(8)],
        "input": [(0.05 + 0.75/8*3, 1 - i * PORT_SPACING_FACTOR * 7) for i in range(2)],
    },
    "opx+": {
