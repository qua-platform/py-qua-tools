...
config["elements"]["qubit"]["intermediate_frequency"] = 126.1e6
...
for i in range(len(freqs_external)):  # Loop over the LO frequencies
    ...
    qm.octave.set_lo_frequency("qubit", freqs_external[i])  # Replace by your own function and add time.sleep() if needed
