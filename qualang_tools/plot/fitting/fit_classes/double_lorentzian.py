...
class DoubleLorentzian(FittingBaseClass):
    ...
    def __init__(
        ...
        """
        Create a fit of a - lorentzian for two lorentzians, each with different scaling factors
    ...
    def load_guesses(self, guess_dict):
        ...
        for key, guess in guess_dict.items():
            assert len(guess) == 2, 'please provide guesses as a 2-list (a guess of that parameter for each lorentzian)'
            if key == "lambdas":
    ...
    def double_lorentzian_fn(self, x_var, a0, a1, a2, a3, a4, a5, a6):
        ...
        return (a0 * self.guess_offset) - lorentzian_0 - lorentzian_1

    def func(self, *params):
        return self.double_lorentzian_fn(*params)
