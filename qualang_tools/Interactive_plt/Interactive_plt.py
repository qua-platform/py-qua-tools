...
class InteractivePlotLibFigure:
    ...
    def predefined_fit(self, req="g"):
        ...
        for line in lines:
            ...
            if req == 'd_sin':
                fit = Fitting()
                fit_function = fit.decay_sine(x, y)
                save = Save()
                save.save_params(x, y, fit_function, id='sin'+'_#'+str(i))

                (l,) = plt.plot(x, fit_function["fit_func"](x), "m", linewidth=2)
                setattr(l, "InteractivePlotLib_Type", "Fit")
                setattr(l, "fit_func", fit_function["fit_func"])
                i = i + 1
            ...
            if req == 'tl':
                ...
                save = Save()
                save.save_params(x, y, fit_function, id='transmitted_lorenzian'+'_#'+str(i))
            ...
            if req == 'rl':
                ...
                save = Save()
                save.save_params(x, y, fit_function, id='reflected_lorenzian'+'_#'+str(i))
            ...
            if req == 'lin':
                fit = Fitting()
                fit_function = fit.linear(x, y)
                save = Save()
                save.save_params(x, y, fit_function, id='linear' + '_#' + str(i))
        ...
        #         self.ax,
        #         {
        #             "text": lambda x_shift, y_shift, x_scale,
        #                            y_scale: f" A = {y_scale},Sigma = {x_scale} \n y_shift = {y_shift},Center_x = {x_shift}"
        #         },
        #     )
        # elif req == "e":
        #     gauss_factor = 5
        ...
        #         {
        #             "text": lambda x_shift, y_shift, x_scale,
        #                            y_scale: f" A = {y_scale * np.exp(-x_shift / x_scale * gauss_factor)}, \n Tau = {-x_scale / gauss_factor}"
        #         },
        #     )
        # elif req == "l":
        #     Fit(
        ...
        #         {
        #             "text": lambda x_shift, y_shift, x_scale,
        #                            y_scale: f" A = {y_scale},1/x_prefactor = {x_scale} \n y_shift = {y_shift},Center_x = {x_shift}"
        #         },
        #     )
        # elif req == "r":
        #     Fit(
